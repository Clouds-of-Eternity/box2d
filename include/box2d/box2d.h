...
B2_API b2ShapeId b2World_GetShapeId( b2WorldId worldId, int index );

B2_API b2DynamicTree *b2World_GetDynamicTree( b2WorldId worldId, b2BodyType forBodiesOfType );
